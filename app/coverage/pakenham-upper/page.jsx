...
export const metadata = {
  title:
    "Ducted Heating Services Pakenham Upper Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Pakenham Upper, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Pakenham Upper and surrounding suburbs.",
  keywords:
    "ducted heating services pakenham upper, ducted heating installation pakenham upper, ducted heating repairs Melbourne, pakenham upper HVAC heating, ducted heating systems pakenham upper",
};
...
export default function PakenhamUpperDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Pakenham Upper Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="pakenham upper ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Pakenham Upper, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Pakenham Upper Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Pakenham Upper.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Pakenham Upper and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Pakenham Upper:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Pakenham Upper Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Pakenham Upper from our certified HVAC technicians today!"
