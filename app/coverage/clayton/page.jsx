...
export const metadata = {
  title:
    "hydronic heating Services Clayton Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional hydronic heating services in Clayton, Melbourne. Expert installation, repairs, and maintenance for all hydronic heating systems. Certified HVAC technicians serving Clayton and surrounding suburbs.",
  keywords:
    "hydronic heating services clayton, hydronic heating installation clayton, hydronic heating repairs Melbourne, clayton HVAC heating, hydronic heating systems clayton",
};
...
export default function ClaytonDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="hydronic heating Services Clayton Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="clayton hydronic heating services"
                  dataTitle="Professional hydronic heating Services in Clayton, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="hydronic heating Services Clayton Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive hydronic heating services in Clayton.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of hydronic heating systems across Clayton and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  hydronic heating Services We Provide in Clayton:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Clayton hydronic heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for hydronic heating installation, repair, or servicing in Clayton from our certified HVAC technicians today!"
