...
export const metadata = {
  title:
    "Ducted Heating Services St Kilda East Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in St Kilda East, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving St Kilda East and surrounding suburbs.",
  keywords:
    "ducted heating services st kilda east, ducted heating installation st kilda east, ducted heating repairs Melbourne, st kilda east HVAC heating, ducted heating systems st kilda east",
};
...
export default function StKildaEastDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services St Kilda East Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="st kilda east ducted heating services"
                  dataTitle="Professional Ducted Heating Services in St Kilda East, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services St Kilda East Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in St Kilda East.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across St Kilda East and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in St Kilda East:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local St Kilda East Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in St Kilda East from our certified HVAC technicians today!"
