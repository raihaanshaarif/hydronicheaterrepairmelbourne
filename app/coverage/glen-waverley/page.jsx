...
export const metadata = {
  ...
  alternates: {
    canonical:
      "https://ductedheaterrepairmelbourne.com.au/coverage/glen-waverley",
  },
  other: {
    "geo.region": "AU-VIC",
    "geo.placename": "Glen Waverley, Melbourne",
    "geo.position": "-37.8770;145.1631",
    ICBM: "-37.8770, 145.1631",
  },
};
            ...
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                ...
                <p>
                  ...
                  properties requires specialized knowledge when it comes to gas
