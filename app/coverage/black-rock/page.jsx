...
export const metadata = {
  title:
    "Ducted Heating Services Black Rock Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Black Rock, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Black Rock and surrounding suburbs.",
  keywords:
    "ducted heating services black rock, ducted heating installation black rock, ducted heating repairs Melbourne, black rock HVAC heating, ducted heating systems black rock",
};
...
export default function BlackRockDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Black Rock Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="black rock ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Black Rock, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Black Rock Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Black Rock.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Black Rock and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Black Rock:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Black Rock Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Black Rock from our certified HVAC technicians today!"
