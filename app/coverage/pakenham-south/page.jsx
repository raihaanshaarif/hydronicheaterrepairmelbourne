...
export const metadata = {
  title:
    "Ducted Heating Services Pakenham South Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Pakenham South, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Pakenham South and surrounding suburbs.",
  keywords:
    "ducted heating services pakenham south, ducted heating installation pakenham south, ducted heating repairs Melbourne, pakenham south HVAC heating, ducted heating systems pakenham south",
};
...
export default function PakenhamSouthDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Pakenham South Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="pakenham south ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Pakenham South, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Pakenham South Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Pakenham South.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Pakenham South and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Pakenham South:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Pakenham South Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Pakenham South from our certified HVAC technicians today!"
