...
export const metadata = {
  title:
    "Ducted Heating Services Clayton South Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Clayton South, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Clayton South and surrounding suburbs.",
  keywords:
    "ducted heating services clayton south, ducted heating installation clayton south, ducted heating repairs Melbourne, clayton south HVAC heating, ducted heating systems clayton south",
};
...
export default function ClaytonSouthDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Clayton South Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="clayton south ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Clayton South, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Clayton South Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Clayton South.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Clayton South and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Clayton South:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Clayton South Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Clayton South from our certified HVAC technicians today!"
