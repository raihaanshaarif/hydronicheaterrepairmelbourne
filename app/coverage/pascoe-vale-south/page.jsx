...
export const metadata = {
  title:
    "Ducted Heating Services Pascoe Vale South Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Pascoe Vale South, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Pascoe Vale South and surrounding suburbs.",
  keywords:
    "ducted heating services pascoe vale south, ducted heating installation pascoe vale south, ducted heating repairs Melbourne, pascoe vale south HVAC heating, ducted heating systems pascoe vale south",
};
...
export default function PascoeValeSouthDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Pascoe Vale South Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="pascoe vale south ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Pascoe Vale South, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Pascoe Vale South Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Pascoe Vale South.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Pascoe Vale South and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Pascoe Vale South:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Pascoe Vale South Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Pascoe Vale South from our certified HVAC technicians today!"
