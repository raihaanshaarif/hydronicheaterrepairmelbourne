...
export const metadata = {
  title:
    "Ducted Heating Services Point Cook Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Point Cook, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Point Cook and surrounding suburbs.",
  keywords:
    "ducted heating services point cook, ducted heating installation point cook, ducted heating repairs Melbourne, point cook HVAC heating, ducted heating systems point cook",
};
...
export default function PointCookDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Point Cook Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="point cook ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Point Cook, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Point Cook Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Point Cook.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Point Cook and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Point Cook:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Point Cook Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Point Cook from our certified HVAC technicians today!"
