# List of all suburbs (excluding Armadale and Ashwood which are already created)
$suburbs = @(
...
foreach ($suburb in $suburbs) {
    ...
    $functionName = ($suburb -replace " ", "" -replace "'", "") + "GasHeaterServices"
...
export default function $functionName() {
  return (
    <>
      <PageTitle dataTitle="Gas Heater Services $suburb Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="$($suburb.ToLower()) gas heater services"
                  dataTitle="Professional Gas Heater Services in $suburb, Melbourne"
                  dataMaxWidth="630px"
                />
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Gas Heater Services We Provide in $suburb`:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Why Choose Our Gas Heater Services in $suburb?
                </h5>
                <p>
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local $suburb Gas Heater Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for gas heater installation, repair, or servicing in $suburb from our certified gas technicians today!"
