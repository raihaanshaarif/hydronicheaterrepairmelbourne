...
export const metadata = {
  title:
    "hydronic heating Services Box Hill Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional hydronic heating services in Box Hill, Melbourne. Expert installation, repairs, and maintenance for all hydronic heating systems. Certified HVAC technicians serving Box Hill and surrounding suburbs.",
  keywords:
    "hydronic heating services Box Hill, hydronic heating installation Box Hill, hydronic heating repairs Melbourne, Box Hill HVAC heating, hydronic heating systems Box Hill",
  openGraph: {
    title:
      "hydronic heating Services Box Hill Melbourne | Expert Installation & Repair",
    description:
      "Professional hydronic heating services in Box Hill. Licensed technicians, quality installations, emergency repairs available.",
    type: "website",
    locale: "en_AU",
  },
  twitter: {
    card: "summary_large_image",
    title: "hydronic heating Box Hill | Professional HVAC Services",
    description:
      "Expert hydronic heating services in Box Hill Melbourne. Installation, repairs & maintenance by licensed technicians.",
  },
  alternates: {
...
export default function BoxHillGasHeaterServices() {
  return (
    <>
      <PageTitle dataTitle="hydronic heating system Services Box Hill Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="box hill hydronic heating system services"
                  dataTitle="Professional hydronic heating system Services in Box Hill, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="hydronic heating system services box hill melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive hydronic heating system services
                  in Box Hill. As a trusted local hydronic heating specialist, we
                  provide professional installation, repair, and maintenance
                  services for all types of hydronic heating systems across Box
                  Hill and surrounding Melbourne suburbs. Our certified gas
                  technicians understand the unique heating needs of Box Hill
                  homes and deliver reliable, efficient, and safe hydronic heating
                ...
                <div className="sm:flex sm:gap-[30px] mt-[20px]">
                  ...
                  <div className="sm:basis-1/2">
                    <ul className="list__type1">
                      <li>
                        <a href="#">Ducted hydronic heating</a>
                      </li>
                      <li>
                        <a href="#">Gas Wall Furnaces</a>
                      </li>
                      <li>
                        <a href="#">Central hydronic heating</a>
                      </li>
                      <li>
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  hydronic heating system Services We Provide in Box Hill:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Why Choose Our hydronic heating Services in Box Hill?
                </h5>
                <p>
                ...
                <p className="indent__top">
                  ...
                  you&apos;re dealing with an older hydronic heating system that
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Box Hill hydronic heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for hydronic heating system installation, repair, or servicing in Box Hill from our certified gas technicians today!"
              ...
              >
                <div>
                  <div className={`ttsubtitle`}>
                    hydronic heating system Services
                  </div>
