...
export const metadata = {
  title:
    "Ducted Heating Services Kings Park Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Kings Park, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Kings Park and surrounding suburbs.",
  keywords:
    "ducted heating services kings park, ducted heating installation kings park, ducted heating repairs Melbourne, kings park HVAC heating, ducted heating systems kings park",
};
...
export default function KingsParkDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Kings Park Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="kings park ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Kings Park, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Kings Park Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Kings Park.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Kings Park and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Kings Park:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Kings Park Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Kings Park from our certified HVAC technicians today!"
