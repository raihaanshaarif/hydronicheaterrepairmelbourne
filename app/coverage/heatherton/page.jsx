...
export const metadata = {
  title:
    "Ducted Heating Services Heatherton Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Heatherton, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Heatherton and surrounding suburbs.",
  keywords:
    "ducted heating services heatherton, ducted heating installation heatherton, ducted heating repairs Melbourne, heatherton HVAC heating, ducted heating systems heatherton",
};
...
export default function HeathertonDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Heatherton Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="heatherton ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Heatherton, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Heatherton Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Heatherton.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Heatherton and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Heatherton:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Heatherton Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Heatherton from our certified HVAC technicians today!"
