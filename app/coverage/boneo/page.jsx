...
export const metadata = {
  title:
    "Ducted Heating Services Boneo Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Boneo, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Boneo and surrounding suburbs.",
  keywords:
    "ducted heating services boneo, ducted heating installation boneo, ducted heating repairs Melbourne, boneo HVAC heating, ducted heating systems boneo",
};
...
export default function BoneoDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Boneo Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="boneo ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Boneo, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Boneo Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Boneo.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Boneo and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Boneo:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Boneo Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Boneo from our certified HVAC technicians today!"
