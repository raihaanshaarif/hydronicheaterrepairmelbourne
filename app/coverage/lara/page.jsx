...
export const metadata = {
  title:
    "hydronic heating Services Lara Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional hydronic heating services in Lara, Melbourne. Expert installation, repairs, and maintenance for all hydronic heating systems. Certified HVAC technicians serving Lara and surrounding suburbs.",
  keywords:
    "hydronic heating services lara, hydronic heating installation lara, hydronic heating repairs Melbourne, lara HVAC heating, hydronic heating systems lara",
};

//Page Layout
export default function LaraDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="hydronic heating Services Lara Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="lara hydronic heating services"
                  dataTitle="Professional hydronic heating Services in Lara, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="hydronic heating Services Lara Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive hydronic heating services in Lara.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of hydronic heating systems across Lara and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  hydronic heating Services We Provide in Lara:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Lara hydronic heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for hydronic heating installation, repair, or servicing in Lara from our certified HVAC technicians today!"
