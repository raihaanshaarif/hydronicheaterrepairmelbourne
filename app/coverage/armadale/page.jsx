...
export const metadata = {
  title:
    "Ducted Heating Services Armadale Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Armadale, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Armadale and surrounding suburbs.",
  keywords:
    "ducted heating services armadale, ducted heating installation armadale, ducted heating repairs Melbourne, armadale HVAC heating, ducted heating systems armadale",
};
...
export default function ArmadaleDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Armadale Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="armadale ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Armadale, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Armadale Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={`${styles.indent__top2}`}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Armadale.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Armadale and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Armadale:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Why Choose Our Ducted Heating Services in Armadale?
                </h5>
                <p>
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Armadale Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Armadale from our certified HVAC technicians today!"
