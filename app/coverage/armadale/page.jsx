...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Armadale, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Armadale and surrounding suburbs.",
  keywords:
