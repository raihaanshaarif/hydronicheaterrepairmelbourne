...
export const metadata = {
  title:
    "Ducted Heating Services Narre Warren Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Narre Warren, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Narre Warren and surrounding suburbs.",
  keywords:
    "ducted heating services narre warren, ducted heating installation narre warren, ducted heating repairs Melbourne, narre warren HVAC heating, ducted heating systems narre warren",
};
...
export default function NarreWarrenDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Narre Warren Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="narre warren ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Narre Warren, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Narre Warren Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Narre Warren.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Narre Warren and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Narre Warren:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Narre Warren Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Narre Warren from our certified HVAC technicians today!"
