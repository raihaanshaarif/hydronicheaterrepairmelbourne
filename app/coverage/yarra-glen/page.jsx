...
export const metadata = {
  title:
    "Ducted Heating Services Yarra Glen Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Yarra Glen, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Yarra Glen and surrounding suburbs.",
  keywords:
    "ducted heating services yarra glen, ducted heating installation yarra glen, ducted heating repairs Melbourne, yarra glen HVAC heating, ducted heating systems yarra glen",
};
...
export default function YarraGlenDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Yarra Glen Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="yarra glen ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Yarra Glen, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Yarra Glen Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Yarra Glen.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Yarra Glen and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Yarra Glen:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Yarra Glen Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Yarra Glen from our certified HVAC technicians today!"
