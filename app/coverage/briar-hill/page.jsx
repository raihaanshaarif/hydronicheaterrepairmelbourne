...
export const metadata = {
  title:
    "Ducted Heating Services Briar Hill Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Briar Hill, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Briar Hill and surrounding suburbs.",
  keywords:
    "ducted heating services briar hill, ducted heating installation briar hill, ducted heating repairs Melbourne, briar hill HVAC heating, ducted heating systems briar hill",
};
...
export default function BriarHillDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Briar Hill Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="briar hill ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Briar Hill, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Briar Hill Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Briar Hill.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Briar Hill and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Briar Hill:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Briar Hill Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Briar Hill from our certified HVAC technicians today!"
