...
export const metadata = {
  title:
    "Ducted Heating Services Lakes Entrance Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Lakes Entrance, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Lakes Entrance and surrounding suburbs.",
  keywords:
    "ducted heating services lakes entrance, ducted heating installation lakes entrance, ducted heating repairs Melbourne, lakes entrance HVAC heating, ducted heating systems lakes entrance",
};
...
export default function LakesEntranceDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Lakes Entrance Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="lakes entrance ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Lakes Entrance, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Lakes Entrance Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Lakes Entrance.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Lakes Entrance and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Lakes Entrance:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Lakes Entrance Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Lakes Entrance from our certified HVAC technicians today!"
