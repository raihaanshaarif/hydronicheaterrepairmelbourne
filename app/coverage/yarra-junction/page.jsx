...
export const metadata = {
  title:
    "Ducted Heating Services Yarra Junction Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Yarra Junction, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Yarra Junction and surrounding suburbs.",
  keywords:
    "ducted heating services yarra junction, ducted heating installation yarra junction, ducted heating repairs Melbourne, yarra junction HVAC heating, ducted heating systems yarra junction",
};
...
export default function YarraJunctionDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Yarra Junction Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="yarra junction ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Yarra Junction, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Yarra Junction Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Yarra Junction.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Yarra Junction and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Yarra Junction:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Yarra Junction Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Yarra Junction from our certified HVAC technicians today!"
