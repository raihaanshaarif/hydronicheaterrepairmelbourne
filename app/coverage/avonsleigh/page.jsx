...
export const metadata = {
  title:
    "Ducted Heating Services Avonsleigh Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Avonsleigh, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Avonsleigh and surrounding suburbs.",
  keywords:
    "ducted heating services avonsleigh, ducted heating installation avonsleigh, ducted heating repairs Melbourne, avonsleigh HVAC heating, ducted heating systems avonsleigh",
};
...
export default function AvonsleighDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Avonsleigh Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="avonsleigh ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Avonsleigh, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Avonsleigh Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Avonsleigh.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Avonsleigh and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Avonsleigh:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Avonsleigh Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Avonsleigh from our certified HVAC technicians today!"
