...
export const metadata = {
  title:
    "Ducted Heating Services Scoresby Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Scoresby, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Scoresby and surrounding suburbs.",
  keywords:
    "ducted heating services scoresby, ducted heating installation scoresby, ducted heating repairs Melbourne, scoresby HVAC heating, ducted heating systems scoresby",
};
...
export default function ScoresbyDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Scoresby Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="scoresby ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Scoresby, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Scoresby Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Scoresby.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Scoresby and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Scoresby:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Scoresby Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Scoresby from our certified HVAC technicians today!"
