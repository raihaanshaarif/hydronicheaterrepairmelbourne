...
export const metadata = {
  title:
    "hydronic heating Services Botanic Ridge Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional hydronic heating services in Botanic Ridge, Melbourne. Expert installation, repairs, and maintenance for all hydronic heating systems. Certified HVAC technicians serving Botanic Ridge and surrounding suburbs.",
  keywords:
    "hydronic heating services botanic ridge, hydronic heating installation botanic ridge, hydronic heating repairs Melbourne, botanic ridge HVAC heating, hydronic heating systems botanic ridge",
};

//Page Layout
export default function BotanicRidgeDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="hydronic heating Services Botanic Ridge Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="botanic ridge hydronic heating services"
                  dataTitle="Professional hydronic heating Services in Botanic Ridge, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="hydronic heating Services Botanic Ridge Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive hydronic heating services in Botanic Ridge.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of hydronic heating systems across Botanic Ridge and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  hydronic heating Services We Provide in Botanic Ridge:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Botanic Ridge hydronic heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for hydronic heating installation, repair, or servicing in Botanic Ridge from our certified HVAC technicians today!"
