...
export const metadata = {
  title:
    "Ducted Heating Services Botanic Ridge Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional ducted heating services in Botanic Ridge, Melbourne. Expert installation, repairs, and maintenance for all ducted heating systems. Certified HVAC technicians serving Botanic Ridge and surrounding suburbs.",
  keywords:
    "ducted heating services botanic ridge, ducted heating installation botanic ridge, ducted heating repairs Melbourne, botanic ridge HVAC heating, ducted heating systems botanic ridge",
};
...
export default function BotanicRidgeDuctedHeatingServices() {
  return (
    <>
      <PageTitle dataTitle="Ducted Heating Services Botanic Ridge Melbourne" />
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <SectionTitle
                  dataSubtitle="botanic ridge ducted heating services"
                  dataTitle="Professional Ducted Heating Services in Botanic Ridge, Melbourne"
                  dataMaxWidth="630px"
                />
                <div className="leading-none">
                  <Image
                    ...
                    height={511}
                    quality={0}
                    alt="Ducted Heating Services Botanic Ridge Melbourne"
                    loading={`eager`}
                  />
                </div>
                <p className={``}>
                  Stay warm and comfortable throughout Melbourne&apos;s colder
                  months with our comprehensive ducted heating services in Botanic Ridge.
                  As a trusted local HVAC heating specialist, we provide
                  professional installation, repair, and maintenance services
                  for all types of ducted heating systems across Botanic Ridge and surrounding
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Ducted Heating Services We Provide in Botanic Ridge:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Botanic Ridge Ducted Heating Experts
                </h5>
                <p>
                ...
                <PromoLayout
                  dataText="Get a free quote for ducted heating installation, repair, or servicing in Botanic Ridge from our certified HVAC technicians today!"
