...
const colData = [
  {
    id: 1,
    icon: "icon-780840",
    title: "Experienced Gas Heating Team",
    text: "Our technicians have years of hands-on knowledge with all types of gas heating systems.",
  },
  {
    id: 2,
    icon: "icon-2058768",
  ...
  return (
    <div className="md:flex md:gap-[30px]">
      <div className={`basis-1/2 md-max:mt-[-8px]`}>
        ...
        />
        <p>
          Experience the difference with our dedicated gas heater service in
          Melbourne. We deliver reliable, high-quality gas heater repairs,
          ...
          respond promptly to your home or business gas heating needs.
        </p>
        <ul className="list__type1 lg-max:mt-[19px] lg:mt-[33px]">
          <li>Clear, upfront pricing for every gas heating job</li>
