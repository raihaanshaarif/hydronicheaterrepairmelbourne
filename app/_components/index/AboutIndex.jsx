        ...
        <div className={`sm:flex sm:items-start lg-max:gap-[30px] relative`}>
          ...
          <div className="basis-1/2 sm-max:mt-[35px]">
            <SectionTitle
              ...
              dataTitle={
                "Melbourne’s Gas Heating Specialists \n Service You Can Trust"
              }
              dataMaxWidth="468px"
            />
            <p>
              When it comes to gas heater service in Melbourne, our team stands
              out for reliability, expertise, and customer satisfaction. We
              offer comprehensive gas heating solutions, including installation,
              repairs, routine maintenance, and emergency services, all
              delivered by licensed technicians.
            </p>
            <ul className="list__type1 lg:mt-[33px] lg-max:mt-[19px]">
              <li>Professional Gas Heater Installation & Repairs Melbourne</li>
              <li>Affordable Gas Heating Maintenance & Safety Checks</li>
              <li>24/7 Emergency Gas Heater Service Melbourne</li>
            </ul>
            <div
